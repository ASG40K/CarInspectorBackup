...
- Create Angular project with ng: `ng new carinspectorbackup.client --defaults --skip-install --skip-git --no-standalone `.
...
- Create project file (`carinspectorbackup.client.esproj`).
